    ...
    <div className='bg-white px-10 py-20 rounded-3xl border-gray-100'>
        ...
        <div className='mt-8'>
            ...
            <div className='mt-8 flex flex-col gap-y-4'>
                <button className='active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-3xl bg-violet-500 text-white text-lg font-bold'>
                    Se connecter
                </button>
            ...
            <div className='mt-8 flex justify-center items-center'>
                ...
                <button className='text-violet-500 text-base font-medium ml-2'>Inscrivez-vous</button>
            </div>
        </div>
    </div>
  )
